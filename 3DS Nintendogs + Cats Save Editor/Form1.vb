...
Public Class Form1
    ...
    Private Sub AdvH_money_Click(sender As Object, e As EventArgs) Handles AdvH_money.Click
        If Select_language.SelectedItem = Select_language.Items.Item(0) Then
            NCSE_dialog.Text_NCSE_dialog.Text = "You can edit money here, click on money icon to set as maximum"
            NCSE_dialog.ShowDialog()
        End If
        If Select_language.SelectedItem = Select_language.Items.Item(1) Then
            NCSE_dialog.Text_NCSE_dialog.Text = "Vous pouvez editer l'argent ici, cliquez sur l'icône de l'argent pour mettre au maximum"
            NCSE_dialog.ShowDialog()
        End If
        If Select_language.SelectedItem = Select_language.Items.Item(2) Then
            NCSE_dialog.Text_NCSE_dialog.Text = "Sie können hier Geld bearbeiten. Klicken Sie auf das Geldsymbol, um das Maximum festzulegen"
            NCSE_dialog.ShowDialog()
        End If
    End Sub

    Private Sub AdvH_homestyle_Click(sender As Object, e As EventArgs) Handles AdvH_homestyle.Click
        If Select_language.SelectedItem = Select_language.Items.Item(0) Then
            NCSE_dialog.Text_NCSE_dialog.Text = "You can edit home style here"
            NCSE_dialog.ShowDialog()
        End If
        If Select_language.SelectedItem = Select_language.Items.Item(1) Then
            NCSE_dialog.Text_NCSE_dialog.Text = "Vous pouvez editer le style de l'intérieur ici"
            NCSE_dialog.ShowDialog()
        End If
        If Select_language.SelectedItem = Select_language.Items.Item(2) Then
            NCSE_dialog.Text_NCSE_dialog.Text = "Sie können hier Geld bearbeiten. Klicken Sie auf das Geldsymbol, um das Maximum festzulegen"
    ...
    Private Sub AdvH_trainerpoints_Click(sender As Object, e As EventArgs) Handles AdvH_trainerpoints.Click
        If Select_language.SelectedItem = Select_language.Items.Item(0) Then
            NCSE_dialog.Text_NCSE_dialog.Text = "Set as blue to set trainer points as maximum"
            NCSE_dialog.ShowDialog()
        End If
        If Select_language.SelectedItem = Select_language.Items.Item(1) Then
            NCSE_dialog.Text_NCSE_dialog.Text = "Mettre en bleu pour mettre les points d'entraineur au maximum"
            NCSE_dialog.ShowDialog()
        End If
        If Select_language.SelectedItem = Select_language.Items.Item(2) Then
            NCSE_dialog.Text_NCSE_dialog.Text = "Als blau einstellen, um die Trainerpunkte als Maximum festzulegen"
            NCSE_dialog.ShowDialog()
        End If
    End Sub

    Private Sub AdvH_allitems_Click(sender As Object, e As EventArgs) Handles AdvH_allitems.Click
        If Select_language.SelectedItem = Select_language.Items.Item(0) Then
            NCSE_dialog.Text_NCSE_dialog.Text = "Set as blue to unlock all items by numbers"
            NCSE_dialog.ShowDialog()
        End If
        If Select_language.SelectedItem = Select_language.Items.Item(1) Then
            NCSE_dialog.Text_NCSE_dialog.Text = "Mettre en bleu pour débloquer tout les objets par nombre"
            NCSE_dialog.ShowDialog()
        End If
        If Select_language.SelectedItem = Select_language.Items.Item(2) Then
            NCSE_dialog.Text_NCSE_dialog.Text = "Als blau einstellen, um alle Gegenstände nach Zahlen freizuschalten"
            NCSE_dialog.ShowDialog()
        End If
    End Sub

    Private Sub AdvH_animal_1_Click(sender As Object, e As EventArgs) Handles AdvH_animal_1.Click
        If Select_language.SelectedItem = Select_language.Items.Item(0) Then
            NCSE_dialog.Text_NCSE_dialog.Text = "You can edit your animal name here, if show hidden things is checked, you will able to check if you animal is a dog or a cat to edit hidden name"
            NCSE_dialog.ShowDialog()
        End If
        If Select_language.SelectedItem = Select_language.Items.Item(1) Then
            NCSE_dialog.Text_NCSE_dialog.Text = "Vous pouvez modifier le nom de votre animal ici, si afficher les choses cachées est coché, vous pourrez cocher si votre animal est un chien ou un chat pour modifier le nom caché"
            NCSE_dialog.ShowDialog()
        End If
        If Select_language.SelectedItem = Select_language.Items.Item(2) Then
            NCSE_dialog.Text_NCSE_dialog.Text = "Sie können Ihren Tiernamen hier bearbeiten. Wenn Verborgene Dinge anzeigen aktiviert ist, können Sie überprüfen, ob Ihr Tier ein Hund oder eine Katze ist, um den versteckten Namen zu bearbeiten"
            NCSE_dialog.ShowDialog()
        End If
    End Sub

    Private Sub AdvH_animal_2_Click(sender As Object, e As EventArgs) Handles AdvH_animal_2.Click
        If Select_language.SelectedItem = Select_language.Items.Item(0) Then
            NCSE_dialog.Text_NCSE_dialog.Text = "You can edit your animal name here, if show hidden things is checked, you will able to check if you animal is a dog or a cat to edit hidden name"
            NCSE_dialog.ShowDialog()
        End If
    ...
    Private Sub AdvH_animal_3_Click(sender As Object, e As EventArgs) Handles AdvH_animal_3.Click
        If Select_language.SelectedItem = Select_language.Items.Item(0) Then
            NCSE_dialog.Text_NCSE_dialog.Text = "You can edit your animal name here, if show hidden things is checked, you will able to check if you animal is a dog or a cat to edit hidden name"
            NCSE_dialog.ShowDialog()
        End If
    ...
    Private Sub AdvH_animal_4_Click(sender As Object, e As EventArgs) Handles AdvH_animal_4.Click
        If Select_language.SelectedItem = Select_language.Items.Item(0) Then
            NCSE_dialog.Text_NCSE_dialog.Text = "You can edit your animal name here, if show hidden things is checked, you will able to check if you animal is a dog or a cat to edit hidden name"
            NCSE_dialog.ShowDialog()
        End If
    ...
    Private Sub AdvH_animal_5_Click(sender As Object, e As EventArgs) Handles AdvH_animal_5.Click
        If Select_language.SelectedItem = Select_language.Items.Item(0) Then
            NCSE_dialog.Text_NCSE_dialog.Text = "You can edit your animal name here, if show hidden things is checked, you will able to check if you animal is a dog or a cat to edit hidden name"
            NCSE_dialog.ShowDialog()
        End If
    ...
    Private Sub AdvH_animal_6_Click(sender As Object, e As EventArgs) Handles AdvH_animal_6.Click
        If Select_language.SelectedItem = Select_language.Items.Item(0) Then
            NCSE_dialog.Text_NCSE_dialog.Text = "You can edit your animal name here, if show hidden things is checked, you will able to check if you animal is a dog or a cat to edit hidden name"
            NCSE_dialog.ShowDialog()
        End If
    ...
    Private Sub Check_trainerpoints_MouseMove(sender As Object, e As MouseEventArgs) Handles Check_trainerpoints.MouseMove
        If Select_language.SelectedItem = Select_language.Items.Item(0) Then
            Text_description.Text = "Set as blue to set trainer points as maximum"
        ElseIf Select_language.SelectedItem = Select_language.Items.Item(1) Then
            Text_description.Text = "Mettre en bleu pour mettre les points d'entraineur au maximum"
        ElseIf Select_language.SelectedItem = Select_language.Items.Item(2) Then
            Text_description.Text = "Als blau einstellen, um die Trainerpunkte als Maximum festzulegen"
        End If
        Panel_description.Visible = True
    End Sub

    Private Sub Check_trainerpoints_MouseLeave(sender As Object, e As EventArgs) Handles Check_trainerpoints.MouseLeave
        Panel_description.Visible = False
    End Sub

    Private Sub Check_allitems_MouseMove(sender As Object, e As MouseEventArgs) Handles Check_allitems.MouseMove
        If Select_language.SelectedItem = Select_language.Items.Item(0) Then
            Text_description.Text = "Set as blue to unlock all items by numbers"
        ElseIf Select_language.SelectedItem = Select_language.Items.Item(1) Then
            Text_description.Text = "Mettre en bleu pour débloquer tout les objets par nombre"
        ElseIf Select_language.SelectedItem = Select_language.Items.Item(2) Then
            Text_description.Text = "Als blau einstellen, um alle Gegenstände nach Zahlen freizuschalten"
        End If
        Panel_description.Visible = True
    End Sub

    Private Sub Check_allitems_MouseLeave(sender As Object, e As EventArgs) Handles Check_allitems.MouseLeave
        Panel_description.Visible = False
    End Sub
End Class
